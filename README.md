...
- This dropdown allows users to select the type of emergency ("Flood", "Fire", "Earthquake", "Medical", "Crime").
...
*"Please enter your name and location to assist you."*
